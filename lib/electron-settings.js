...
class ElectronSettings extends EventEmitter {
  ...
  constructor(options) {
    ...
    /**
     * Options for this Electron Settings instance.
     *
     * @type Object
     * @default null
     * @private
  ...
  /**
   * Sets up the Electron Settings instance.
   *
   * @param {Object} options
   * @private
   */
  ...
  _save() {
    ...
    // Attempt to save the settings to disk (asynchronous).
  ...
  /**
   * Requests the Electron Settings instance to save the internal settings
  ...
  /**
   * Destroys the Electron Settings instance gracefully. This ensures that any
