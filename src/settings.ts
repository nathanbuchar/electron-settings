...
/**
 * A `SettingsObject` is an object whose values are of the
 * type `SettingsValue`.
 */
...
/**
 * The default Electron Settings configuration. These can
 * be changed via [[configure|configure()]].
 */
 ...
 * @example
 *
 * Change the value of `color.hue` to `blue-ish`.
 *
 * ```ts
 * const h = 'hue';
